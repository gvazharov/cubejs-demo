...
class WebSocketConnection {
    ...
    async query(query, queryTracingObj) {
        ...
        HttpMessage_1.HttpQuery.startHttpQuery(builder);
        HttpMessage_1.HttpQuery.addQuery(builder, queryOffset);
        if (traceObjOffset) {
            HttpMessage_1.HttpQuery.addTraceObj(builder, traceObjOffset);
        }
        const httpQueryOffset = HttpMessage_1.HttpQuery.endHttpQuery(builder);
