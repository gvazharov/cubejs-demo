...
export declare class CubeStoreDriver extends BaseDriver implements DriverInterface {
    ...
    query(query: string, values: any[], queryTracingObj?: any): Promise<any[]>;
    ...
    uploadTableWithIndexes(table: string, columns: Column[], tableData: any, indexesSql: IndexesSQL, uniqueKeyColumns?: string[], queryTracingObj?: any): Promise<void>;
    private importRows;
