...
class CubeStoreDriver extends query_orchestrator_1.BaseDriver {
    ...
    async query(query, values, queryTracingObj) {
        return this.connection.query(sqlstring_1.format(query, values || []), { ...queryTracingObj, instance: shared_1.getEnv('instanceId') });
    }
    async release() {
    ...
    async importRows(table, columns, indexesSql, tableData, queryTracingObj) {
    ...
    async importCsvFile(tableData, table, columns, indexes, queryTracingObj) {
    ...
    async importStream(columns, tableData, table, indexes, queryTracingObj) {
    ...
    async importStreamingSource(columns, tableData, table, indexes, uniqueKeyColumns, queryTracingObj) {
        if (!uniqueKeyColumns) {
