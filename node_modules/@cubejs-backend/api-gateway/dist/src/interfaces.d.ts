...
export declare type QueryTimeDimensionGranularity = 'hour' | 'day' | 'week' | 'month' | 'year' | 'quarter';
...
export declare type CheckSQLAuthSuccessResponse = {
    password: string | null;
    securityContext?: any;
};
export declare type CheckSQLAuthFn = (ctx: any, user: string | null) => Promise<CheckSQLAuthSuccessResponse> | CheckSQLAuthSuccessResponse;
