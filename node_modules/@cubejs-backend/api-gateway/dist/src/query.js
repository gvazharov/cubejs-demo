...
exports.normalizeQueryCancelPreAggregations = exports.normalizeQueryPreAggregationPreview = exports.normalizeQueryPreAggregations = exports.normalizeQuery = exports.validatePostRewrite = exports.getPivotQuery = exports.getQueryGranularity = exports.QUERY_TYPE = void 0;
...
exports.validatePostRewrite = validatePostRewrite;
...
const normalizeQueryPreAggregations = (query, defaultValues) => {
    ...
    return {
        ...
        timezones: query.timezones || (query.timezone && [query.timezone]) || (defaultValues === null || defaultValues === void 0 ? void 0 : defaultValues.timezones) || ['UTC'],
